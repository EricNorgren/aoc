...
def decipher_calibration_document(
    lines: List[str], match_regex: str, match_regex_backward: Optional[str] = None, verbose: Optional[bool] = False
) -> int:
...
def main() -> None:
    ...
    # 53389
    print(
        decipher_calibration_document(
            lines=lines, match_regex=match_regex_part_two_forward, match_regex_backward=match_regex_part_two_backward
        )
    )
