...
def part_two_naive(instructions: str, nodes: Dict[str, Node]) -> None:
    ...
    print("part_two_naive::PART TWO DONE ", num_steps)
...
def part_two_naive_numba(instructions: str, network_map: List[str]) -> None:
    ...
    while not done:
        ...
        if num_steps % 1e6 == 0:
            print("part_two_naive_numba::running... ", num_steps)

    print("part_two_naive_numba::PART TWO DONE ", num_steps)
...
def part_two_lcm(instructions: str, nodes: Dict[str, Node]) -> None:
    ...
    print(f"part_two_lcm::{first_solution_at_step=}")
    print(f"part_two_lcm::{first_solution_at_step.values()=}")
    lcm_answer = math.lcm(*list(first_solution_at_step.values()))
    print(f"part_two_lcm::part two {lcm_answer=}")  # 17099847107071
